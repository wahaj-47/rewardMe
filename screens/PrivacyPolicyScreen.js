...
export default function PrivacyPolicyScreen() {
	return (
		<WebView
			...
			<p>
				MH Reward Me ("us", "we", or "our") operates the MH Reward Me mobile
			...
			<p>
				...
				associated with that data. Our Privacy Policy for MH Reward Me is created with
				the help of the
			...
			<p>
				...
				able to use some portions of our Service. You can learn more how to manage
				cookies in the
			...
			<p>MH Reward Me uses the collected data for various purposes:</p>
			<ul>
			...
			<p>
				If you are located outside Australia and choose to provide information to us,
				please note that we transfer the data, including Personal Data, to Australia
			...
			<p>
				MH Reward Me will take all steps reasonably necessary to ensure that your data
			...
			<p>
				MH Reward Me may disclose your Personal Data in the good faith belief that
				such action is necessary to:
			</p>
			<ul>
				<li>To comply with a legal obligation</li>
				<li>To protect and defend the rights or property of MH Reward Me</li>
				<li>
			...
			<ul>
				<li>By email: hello@mercedeshairdressing.com</li>
			
				<li>By phone number: +6142030774</li>
			</ul>
